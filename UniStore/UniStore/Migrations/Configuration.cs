namespace UniStore.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<UniStoreDbContext>
    {
        ...
        protected override void Seed(UniStore.Models.UniStoreDbContext context)
        {
        ...
        private static void SeedData(UniStoreDbContext context)
        {
        ...
        private static void SeedManufacturers(UniStoreDbContext context)
        {
            var manufacturers = new Dictionary<string, string>
            {
                { "IBM", "USA, 33, office@ibm.com" },
                { "Dell", "0888888888, office@dell.com" },
                { "HP Co", "025551144, salles@hp.com" },
                { "AMD", "office@amd.com" },
                { "DELL", " 15, 0888555555, office@dell.com" },
                { "Canon", "02, contacts@canon.bg" },
            };
        ...
        private static void SeedRolesAndAdmin(UniStoreDbContext context)
        {
        ...
        private static SeedProduct NewProduct(
           ...
           decimal price,
           int quantity,
           int manufacturerId) => new SeedProduct
           {
