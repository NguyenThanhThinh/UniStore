...
namespace UniStore.Models.Repositories
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        {
            return where == null ? await All.AsNoTracking().Including(includes).ToListAsync() : await All.AsNoTracking().Including(includes).Where(where).ToListAsync();
        }
